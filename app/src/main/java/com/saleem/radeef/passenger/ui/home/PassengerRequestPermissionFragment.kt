...
class PassengerRequestPermissionFragment: Fragment(R.layout.driver_request_fragment), EasyPermissions.PermissionCallbacks {
    ...
    private fun navigateToHome() {
        val action = PassengerRequestPermissionFragmentDirections.actionPassengerRequestPermissionFragmentToHomeFragment()
